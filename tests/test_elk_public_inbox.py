...
class TestPublicInbox(TestBaseBackend):
    """Test PublicInbox backend"""

    connector = "public_inbox"
    ...
    def test_perceval_params(self):
        """Test the extraction of perceval params from a URL"""

        url = "metrics-grimoire /home/bitergia/.perceval/public_inbox"
        expected_params = [
            'metrics-grimoire',
            '/home/bitergia/.perceval/public_inbox'
        ]
        self.assertListEqual(PublicInboxOcean.get_perceval_params_from_url(url), expected_params)
